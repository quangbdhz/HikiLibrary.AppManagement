...
namespace Library_Management.Model
{
    ...
    public partial class ListBookLibraryBorrowHuman : BaseViewModel
    {
        private int _Id;
        public int Id { get => _Id; set { _Id = value; OnPropertyChanged(); } }

        private int _IdBillBookOfHuman;
        public int IdBillBookOfHuman { get => _IdBillBookOfHuman; set { _IdBillBookOfHuman = value; OnPropertyChanged(); } }
        ...
        public virtual BillBookOfHuman BillBookOfHuman { get; set; }
