...
namespace Library_Management.Model
{
    ...
    public partial class ListReturnBookHuman : BaseViewModel
    {
        private int _Id;
        public int Id { get => _Id; set { _Id = value; OnPropertyChanged(); } }

        private int _IdBillReturnBookHuman;
        public int IdBillReturnBookHuman { get => _IdBillReturnBookHuman; set { _IdBillReturnBookHuman = value; OnPropertyChanged(); } }
        ...
        public virtual BillReturnBookHuman BillReturnBookHuman { get; set; }
